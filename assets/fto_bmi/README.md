...
be turned into a module. Published as a rehearsal to `test-ns/fto_bmi@1.0.0` on the polygon.
...
`test-ns/fto_bmi` now returns `404 module_not_found`, which is the cleanup working and not a
