...
> each docs build, at <https://just-dna.life/just-dna-compiler/tables/literature/>. Upstream's hand-written
...
> `describe_machine_table("literature.csv")` — **not** `describe_table`, which refuses every
