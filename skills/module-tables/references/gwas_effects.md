...
> each docs build, at <https://just-dna.life/just-dna-compiler/tables/gwas_effects/>. Upstream's hand-written
...
> `describe_machine_table("gwas_effects.csv")` — **not** `describe_table`, which refuses every
