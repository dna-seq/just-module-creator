...
> each docs build, at <https://just-dna.life/just-dna-compiler/tables/resolution/>. Upstream's hand-written
...
> `describe_machine_table("resolution.csv")` — **not** `describe_table`, which refuses every
...
answers it in full. (Nor is a hand-written row here forbidden: `source` documents
