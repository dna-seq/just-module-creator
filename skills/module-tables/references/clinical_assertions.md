...
> each docs build, at <https://just-dna.life/just-dna-compiler/tables/clinical_assertions/>. Upstream's hand-written
...
> `describe_machine_table("clinical_assertions.csv")` — **not** `describe_table`, which refuses every
