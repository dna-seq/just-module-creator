...
> each docs build, at <https://just-dna.life/just-dna-compiler/tables/gene_validity/>. Upstream's hand-written
...
> `describe_machine_table("gene_validity.csv")` — **not** `describe_table`, which refuses every
